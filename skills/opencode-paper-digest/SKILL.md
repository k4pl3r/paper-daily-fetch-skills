---
name: opencode-paper-digest
description: Use when OpenCode needs to fetch recent papers by configurable keywords and write a Markdown digest to a chosen output_path.
---

# OpenCode Paper Digest
